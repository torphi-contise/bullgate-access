...
[![Quality gate](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=coverage)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Lines of code](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access)<br>
[![Maintainability](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Reliability](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Security](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access)<br>
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=bugs)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access) [![Code smells](https://sonarcloud.io/api/project_badges/measure?project=torphi-contise_bullgate-access&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=torphi-contise_bullgate-access)
