...
/// <summary>Reads the current email for an identity inside an explicit realm.</summary>
public sealed class IdentityEmailReader(IIdentityEmailStore store)
{
    /// <summary>
    /// Reads an active identity's normalized e-mail without broadening the explicit
